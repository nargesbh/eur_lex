...
# --- Filter only English metadata (_(lang).jsonl) ---
meta_df = meta_df[meta_df["filepath"].astype(str).str.endswith("_LV.jsonl")].reset_index(drop=True)
print(f"Filtered to {len(meta_df)}  (_().jsonl) entries")
