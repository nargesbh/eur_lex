...
for domain_no in range(20, 19, -1):
    ...
    for year in range(2024, 2023, -1):
        ...
        print("Scraping URL:", provided_url_year)
        ...
        non_existing_celex_number = list_celex_number  # just skip the check
        ...
        get_document_information(None, index_name, non_existing_celex_number)
